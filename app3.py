...
class ForecastModel:
    def __init__(self, model_path: str = "model.pkl"):
        self.model = None
        self.model_path = model_path  # Set the model path here (hard-coded)
...
def main():
    ...
    # Use a fixed model path
    model_path = "model.pkl"
    forecast_model = ForecastModel(model_path="./20250222123045_model.pkl")

    with st.expander("What does our model do?"): st.write(""" 
                        ...
                        """)
    with st.expander("How does this help TouchBistro?"): st.write(""" 
    ...
    st.write(
        "Click the button below to generate a forecast for the specified concept, city, and country."
    )
    ...
    # st.write("The model used for forecasting was trained with historical order data and saved as a `.pkl` file. It uses **Prophet** to generate forecasts based on time-series data.")
